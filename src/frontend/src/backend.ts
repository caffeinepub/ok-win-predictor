...
export class Backend implements backendInterface {
    ...
    async generatePrediction(arg0: string, arg1: bigint, arg2: bigint): Promise<Prediction> {
        if (this.processError) {
            try {
                const result = await this.actor.generatePrediction(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getPredictionHistory(): Promise<Array<Prediction>> {
        if (this.processError) {
            try {
